...
class Help(Cog_Extension):
    ...
    async def help(self, interaction: discord.Interaction):
        ...
        embed.add_field(name="/bing_setting", value="Set and delete your Bing Cookies.", inline=False)
        embed.add_field(name="/bing", value="Chat with Bing.", inline=False)
        embed.add_field(name="/reset_conversation", value="Reset your Bing conversation.", inline=False)
